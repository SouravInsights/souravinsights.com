...
export const BookCard: React.FC<BookCardProps> = ({ book }) => {
  ...
  return (
    ...
    >
      <Card className="h-full overflow-hidden bg-card border border-border">
            ...
            {book.readwiseId && (
              <Link href={`/books/${book.readwiseId}/highlights`} passHref>
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full mt-2 text-green-600 border-green-600 hover:bg-green-600 hover:text-white dark:text-green-500 dark:border-green-500 dark:hover:bg-green-500 dark:hover:text-background"
                >
